...
def evaluate_pipeline(pipeline_predictions, label_column_name: str):
...
evaluation_result = evaluate_pipeline(pipeline_predictions=test_predictions,  label_column_name="Runs")
...
evaluate_pipeline(validation_predictions,  label_column_name="Runs")
